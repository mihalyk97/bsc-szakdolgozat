...
public func configure(_ app: Application) throws {
    ...
    app.databases.middleware.use(JitsiConsultationMiddleware(application: app), on: .psql)
    ...
    //app.migrations.add(UpdateOrganizationWithJitsiUrl())
    app.migrations.add(CreateActivity())
    //app.migrations.add(UpdateActivityWithDisabled())
    app.migrations.add(CreateClient())
    app.migrations.add(CreateEmployee())
    app.migrations.add(CreateAppointment())
    //app.migrations.add(UpdateAppintmentWithOnline())
